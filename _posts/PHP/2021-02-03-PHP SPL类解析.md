...
SPL 提供了一套标准的数据结构、遍历对象的迭代器、异常，以及一些处理文件的类，
它还提供了一系列的函数，比如 `spl_autoload_register()`。 
...
![]({{site.baseurl}}/images/20210204/20210204113212.png)

<br/><br/><br/><br/><br/>
## 参考资料

PHP 手册 函数参考 其它基本扩展 PHP标准库 (SPL) <https://www.php.net/manual/zh/book.spl.php>

PHP 手册 语言参考  预定义接口 <https://www.php.net/manual/zh/reserved.interfaces.php>

视频 php入门到不放弃34-标准库SPL介绍 <https://haokan.baidu.com/v?pd=wisenatural&vid=336462461276701203>
