...
SQL追踪器：介绍了作者自己写的一个SQL辅助工具，可以快速查看SQL执行log

数据库-基本操作、数据库-事务、链式操作：

![]({{site.baseurl}}/images/20220211/20220211152128.png)

查询语言：

![]({{site.baseurl}}/images/20220211/20220211152743.png)
