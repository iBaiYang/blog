...
`$app = require_once __DIR__.'/../bootstrap/app.php'; ` 初始化应用，返回一个应用实例。看下源码：
```php
<?php
...
* tagsList：标签的列表的映射关系。
* tagItems：标签的对象的映射关系。
* tagItemsList：标签的对象的列表的映射关系。
* tagItemsCount：标签的对象的数量的映射关系。
* tagItemsCountList：标签的对象的数量的列表的映射关系。
* tagItemsCountListList：标签的对象的数量的列表的列表的映射关系。
* tagItemsCountListListList：标签的对象的数量的列表的列表的列表的映射关系。
* tagItemsCountListListListList：标签的对象的数量的列表的列表的列表的列表的映射关系。
