...
[githubstatus.com](https://www.githubstatus.com/) 是 GitHub 官方的服务状态监控页，作用是实时展示 GitHub 所有服务是否正常、是否故障、是否在维护，方便开发者快速判断问题出在自己这边还是 GitHub 平台本身。All Systems Operational = 当前 GitHub 一切正常。githubstatus.com = GitHub 的官方 “健康码”，出问题先看它。
