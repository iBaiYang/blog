...
![]({{site.baseurl}}/images/202309102/20230910232313.png)

运行流程：

![]({{site.baseurl}}/images/202309102/20230910232630.png)

![]({{site.baseurl}}/images/202309102/20230910232659.png)
...
这里， `$_template = '/post/<action>/<id>/'` ，因此，转换后再去除多余的 `/` 就变成了`$url = 'post/view'` 。
其中 id=100 被省略掉了。
...
应该是 `http://www.digapge.com/index.php/post/view.html` 。 自然，这 post/view.html 就是 PATH_INFO 了。 
