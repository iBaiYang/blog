...
![]({{site.baseurl}}/images/20191227/Bubble_sort_animation.gif)
...
![]({{site.baseurl}}/images/20191227/Selection_sort_animation.gif)

![]({{site.baseurl}}/images/20191227/Selection-Sort-Animation.gif)
...
![]({{site.baseurl}}/images/20191227/Insertion_sort_animation.gif)
...
![]({{site.baseurl}}/images/20191227/Sorting_shellsort_anim.gif)
...
![]({{site.baseurl}}/images/20191227/Merge_sort_animation2.gif)

![]({{site.baseurl}}/images/20191227/Merge-sort-example-300px.gif)
...
在区间中随机挑选一个元素作基准，将小于基准的元素放在基准之前，大于基准的元素放在基准之后，
再分别对小数区与大数区进行排序。

![]({{site.baseurl}}/images/20191227/Sorting_quicksort_anim.gif)
